"""XSS Payload Tester - entry point (portable GUI app)."""
import os
import sys
import traceback
...
if __name__ == "__main__":
    try:
        ...
        log_dir = Path(os.environ.get("XSSTESTER_LOG_DIR", _APP_DIR))
        try:
        ...
        try:
            ...
            mb.showerror("XssTester - startup error", traceback.format_exc())
        except Exception:
            pass
        raise